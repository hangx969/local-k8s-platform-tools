...
| eck-operator | 用于简化部署、管理Elastic Stack组件 | [ECK-operator]([learning-notes/Docker-Kubernetes/Monitoring-Logging/Operator部署ECK日志收集平台.md at main · hangx969/learning-notes](https://github.com/hangx969/learning-notes/blob/main/Docker-Kubernetes/Monitoring-Logging/Operator部署ECK日志收集平台.md)) |
...
| grafana                         | https://grafana.github.io/helm-charts                        | loki                            | 6.31.0        | https://github.com/grafana/loki/releases                     | https://artifacthub.io/packages/helm/grafana/loki            |
| grafana                         | https://grafana.github.io/helm-charts                        | promtail                        | 6.17.0        | https://github.com/grafana/loki/releases                     | https://artifacthub.io/packages/helm/grafana/promtail        |
| grafana                         | https://grafana.github.io/helm-charts                        | tempo                           | 1.23.2        | https://github.com/grafana/tempo/releases                    | https://artifacthub.io/packages/helm/grafana/tempo           |
...
| fairwinds-stable                | https://charts.fairwinds.com/stable                          | vpa                             | 4.7.2         | https://github.com/kubernetes/autoscaler/releases            | https://artifacthub.io/packages/helm/fairwinds-stable/vpa    |
| fairwinds-stable                | https://charts.fairwinds.com/stable                          | goldilocks                      | 9.0.2         | https://github.com/FairwindsOps/goldilocks/releases          | https://artifacthub.io/packages/helm/fairwinds-stable/goldilocks |
